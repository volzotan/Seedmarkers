...
bar = axs[0].bar(x_pos, np.average(obtrusive, axis=0), align='center', color=COLOR_4, edgecolor="#999999")
bar = axs[1].bar(x_pos, np.average(aesthetic, axis=0), align='center', color=COLOR_4, edgecolor="#999999")
bar = axs[2].bar(x_pos, np.average(acceptable, axis=0), align='center', color=COLOR_4, edgecolor="#999999")
